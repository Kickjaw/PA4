...
void SortedList::InsertItem(long itemValue){
	...
	listItem *p = new listItem(itemValue); //allocates and initializes memory for new class object

	if (!head) { //if it is the first item in the linked list set it as the head
		head = p;
